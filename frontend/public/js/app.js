(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".quote-swiper")) new swiper_core_Swiper(".quote-swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".feature-swiper")) new swiper_core_Swiper(".feature-swiper", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
...
*/
    ...
    gsapWithCSS.from(".clip-top, .clip-bottom", 2, {
        delay: 1,
        height: "50vh",
        ease: "power4.inOut"
    });
    gsapWithCSS.to(".marquee", 3.5, {
        delay: .75,
        top: "50%",
        ease: "power4.inOut"
    });
    gsapWithCSS.from(".clip-top .marquee, .clip-bottom .marquee", 5, {
        delay: 1,
        left: "100%",
        ease: "power3.inOut"
    });
    gsapWithCSS.from(".clip-center .marquee", 4.5, {
        delay: 1,
        opacity: .9,
        left: "-100%",
        ease: "power3.inOut"
    });
    gsapWithCSS.to(".clip-top", 2, {
        delay: 6,
        clipPath: "inset(0 0 100% 0)",
        ease: "power4.inOut"
    });
    gsapWithCSS.to(".clip-bottom", 2, {
        delay: 6,
        clipPath: "inset(100% 0 0 0)",
        ease: "power4.inOut"
    });
    gsapWithCSS.to(".clip-top .marquee, .clip-bottom .marquee, .clip-center .marquee span", 1, {
    ...
    gsapWithCSS.to(".collection__image", {
        scrollTrigger: {
            trigger: ".collection",
            start: "top 110%",
            end: " top bottom",
    ...
    gsapWithCSS.to(".feature-slide__image", {
        scrollTrigger: {
            trigger: ".feature",
            start: "top 50%",
            toggleActions: "play none none none"
    ...
    gsapWithCSS.to(".card-jornal__image", {
        scrollTrigger: {
            trigger: ".jornal",
            start: "top 110%",
            toggleActions: "play none none none"
